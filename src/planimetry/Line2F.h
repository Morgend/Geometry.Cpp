/*
 * Copyright 2020-2021 Andrey Pokidov <andrey.pokidov@gmail.com>Line2F
 *
...
namespace geometry
{
    namespace planimetry
    {
        ...
        public:
            inline Line2F();
            inline Line2F(const Vector2F& basicPoint, const Vector2F& direction);
            virtual ~Line2F();
        ...
        Line2F::Line2F(const Vector2F& basicPoint, const Vector2F& direction)
        ...
        bool Line2F::isValid() const
        {
            return this->valid;
        }

        const Vector2F& Line2F::basic() const
        {
            return this->linePoint;
        }

        const Vector2F& Line2F::direction() const
        {
            return this->lineDirection;
        }

        Vector2F Line2F::pointAt(const float position) const
        {
            return Vector2F(
