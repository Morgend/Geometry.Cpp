...
namespace geometry
{
    namespace common
    {
        template<typename FloatType> class Vector2Template
        {
        public:
            ...
            inline Vector2Template operator+(const Vector2Template& vector) const;
            inline Vector2Template operator-(const Vector2Template& vector) const;
            inline Vector2Template operator*(const FloatType value) const;
            inline Vector2Template operator/(const FloatType value) const;

            inline Vector2Template& operator+=(const Vector2Template& vector);
            inline Vector2Template& operator-=(const Vector2Template& vector);
            inline Vector2Template& operator*=(const FloatType value);
            inline Vector2Template& operator/=(const FloatType value);
